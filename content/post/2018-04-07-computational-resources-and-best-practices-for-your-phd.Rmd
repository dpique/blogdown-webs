---
title: Computational resources and best practices for your PhD
author: Daniel Pique
date: '2018-04-07'
...
Below are some computer-related things that you need to do or know about while doing your PhD at Einstein. I have supplemented and customized this list with the resources that Einstein offers to facilitate this. The resources are a bit spread out across multiple websites, but hopefully this list helps synthesize these different resources.  
Below are some computational resources offered by Einstein, along with people you should get in touch with to obtain these resources. I divide these best practices into essentials, for every student, and optionals, useful for those doing computationally intensive work. I also include some freely available resources not specific to Einstein but that may be helpful to students generally, along with links to 
...
##### 2. Maintaining a lab notebook 
  ...
  **How do I organize my analyses/experiments and daily tasks?**
  ...
  - Be prepared to spend a considerable amount of time maintaining a lab notebook. A good notebook requires sustained daily effort but can really pay off. PIs will often pay attention to your lab notebook, and it can be impressive to have a well-organized one. The lab notebook can be electronic (ELN) or paper copy, ask your PI if he/she has a preference.
- There are several ideas good free tools and ideas related to ELNs. There's not one solution that best fits all. I would definitely consider electronic lab notebooks (ELN), even if you're doing experimental work. Automatic backups, accessibility from anywhere, ability to add timestamps, and shareability with your PI (or others) would be a few of the advantages of the ELN.
...
Mendeley reference management (free), not specific to Einstein. Use the online plug-in to add citations and download pdfs automatically while you are browsing. Makes it easy to create bibliographies and in-text citations.
